...
#crear modelo
model = miniVGGnet.build(width=in_size, height=in_size, depth=3, n_clases=n_clases)
...
model.save('model_MyDNN_CatDogPerson.h5', save_format="h5")
...
#load the model
model_test = load_model('model_MyDNN_CatDogPerson.h5')
